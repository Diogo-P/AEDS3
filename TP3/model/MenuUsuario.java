...
public class MenuUsuario {
    ...
    private static boolean mostrarCalculos;
        ...
        while (runningListagem) {
            ...
            if ( mostrarCalculos ) {
                ...
                for ( BuscadorProduto.ResultadoBusca r : pagina ) {
                    if ( r != null )  {
                        Produto p = r.getProduto();
                        System.out.println("[" + idx + "] " + p.getNome());
                    }
                    idx++;
                }
                System.out.println();
    ...
    private void inicializarBuscador() throws Exception {
        if (buscadorProduto == null) {
            buscadorProduto = new BuscadorProduto("./dados/produto.palavras.d.db", "./dados/produto.palavras.c.db", arqProduto);
    ...
    public void telaMenuUsuario() throws Exception {
        ...
        while (runningMenuUsuario) {
            ...
            System.out.println("(M) Mudar modo debug (Atualmente: ");
            if ( ! mostrarCalculos ) { System.out.print("in"); }    System.out.print("ativado) -> modo de mostrar cálculos da lista invertida");
            System.out.println();
            System.out.println("(S) Sair");
            System.out.println();
            System.out.print("Opcao: ");
