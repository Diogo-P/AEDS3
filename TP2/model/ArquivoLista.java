...
public class ArquivoLista extends Arquivo<Lista> {
    ...
    public boolean update(Lista novaLista) throws Exception {
        // Le a versao antiga da lista antes de atualizar
        ...
        if (super.update(novaLista)) {
            // Atualiza indice de código, se mudou
            ...
            // Se voce também tiver indice para nome ou descricao,
    ...
    public Lista lerCodigo(String codigo) {
        try {
            ...
            System.err.println("Erro na pesquisa da lista por indice do sistema");
        }
        return null;
    }
