 ...
 * Cada registro liga uma lista a um produto, com quantidade e observacoes.
 */
public class ListaProduto implements Entidade {

    private int id;             // ID do relacionamento (unico)
    ...
    public String toString() {
        return "\nID.............: " + this.id +
               ...
               "\nObservacoes....: " + (this.observacoes.isEmpty() ? "(nenhuma)" : this.observacoes);
    }
}
